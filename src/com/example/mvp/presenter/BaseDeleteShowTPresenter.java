...
import com.example.mvp.view.BaseDeleteTView;
import com.google.gson.Gson;
import com.squareup.okhttp.Callback;
import com.squareup.okhttp.Request;
import com.squareup.okhttp.Response;

public class BaseDeleteShowTPresenter<T,V> {
	private BaseModel<T> mModel;
	private BaseDeleteTView<V> mDeleteView;
	...
	private BaseResponseBean<V> mDeleteRsp = new BaseResponseBean<V>();
	
	public BaseDeleteShowTPresenter(BaseDeleteTView<V> mDeleteView){
...
//	  			Type type = new TypeToken<BaseResponseBean<V>>(){}.getType();  type由所在的activity进行传递
	...
	private void showDelete(){
		mDeleteView.deleteV(rp, mDeleteRsp.getData(), mDeleteRsp.getStatus(), mDeleteRsp.getMsg());
	}
}
